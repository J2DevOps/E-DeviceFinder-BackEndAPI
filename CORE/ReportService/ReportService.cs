    ...
    public class ReportService : IReportService
    {
        ...
        public async Task<ResponseDto> GetReportByIdAsync(string reportId)
        {
            ...
            catch(Exception ex)
            {
                ...
                return new ResponseDto { StatusCode = 500, Message = "An error occurred while fetching the report.", ErrorDetails = ex.Message };
            }
        }
        ...
        public async Task<ResponseDto> CreateReport(ReportRequestDto reportRequest)
        {
            ...
            if(string.IsNullOrWhiteSpace(reportRequest.Title) || string.IsNullOrWhiteSpace(reportRequest.Description) || string.IsNullOrWhiteSpace(reportRequest.UserId))
            {
            ...
            {
                // Log the exception
                return new ResponseDto { StatusCode = 500, Message = "An error occurred while creating the report.", ErrorDetails = ex.Message };
            }
        }
        ...
        public async Task<ResponseDto> UpdateReport(string reportId, ReportRequestDto reportRequest)
        {
            ...
            {
                // Log the exception
                return new ResponseDto { StatusCode = 500, Message = "An error occurred while updating the report.", ErrorDetails = ex.Message };
            }
        }
        ...
        public async Task<ResponseDto> DeleteReport(string reportId)
        {
            ...
            {
                // Log the exception
                return new ResponseDto { StatusCode = 500, Message = "An error occurred while deleting the report.", ErrorDetails = ex.Message };
            }
        }
    }
